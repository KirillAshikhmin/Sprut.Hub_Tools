...
## Инстуркция по установке
 ...
 1. Скачать файлы 
    ...
    Если необходимо менять температуру и у ламп, которые поддерживают
    изменение только цвета, но не температуры так же скачать 
    
    > Конвертер температуры в цвет.json
 2. Открыть сценарии, нажать справа сверху кнопку +, выбрать
    "Импортировать шаблон" и по очереди импортировать все файлы.
 3. Зайти в нужное устройство (тип - Лампочка)
 4. Если прошивка 1.10 и выше, то в настройки (шестерёнка сверху
    справа), для версий младше сразу на следующий шаг
 5. Логика
 6. Циркадное освещение
 7. Активировать.
