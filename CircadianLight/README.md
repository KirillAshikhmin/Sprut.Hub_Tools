...
# История изменений:
## 4.1
- Исправление включения лампы при вызове сброса или включения циркадного режима через вызов глобальной функции enableCircadianLightFor или resetCircadianLightFor
