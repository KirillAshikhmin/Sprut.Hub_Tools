...
# История изменений:
## 4.3
- Новый логический сценарий "Отключение циркадного освещения" для выключетелей - включает и отключает режим циркадного освещения у указанных ламп (до 10 штук)
