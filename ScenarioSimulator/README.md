...
./publish                                     # без имени — интерактивный выбор сценария и параметров
...
Полное руководство по инструменту — [`Publish.md`](../Publish.md) в корне репозитория (интерактивный режим, конфигурации запуска для IDEA в `.run/`, помощник `./sim`).
